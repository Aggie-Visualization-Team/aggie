...
OjoConElVotoContentService.prototype._doRequest = function(callback) {
...
OjoConElVotoContentService.prototype._validate = function(data) {
    if (!data.authoredAt) {
...
OjoConElVotoContentService.prototype._isNew = function(data) {
